...
## 2026-06-15 Troubleshooting: ��ġ ���� ��û ��� ����� ��� ���̰� 422 ������ �����

����:

�л��� �Խñ��� �ۼ��� �� `/coach-review`�� �̵������� ���� ��� ���� ������ ��� �ۼ��� �Խñ��� ������ �ʾҴ�.
ȭ�鿡�� `Input should be less than or equal to 50` ������ ���� ������.

����:

`frontend/src/app/pages/coach/CoachReview.tsx`���� �л��� �� �Խñ� ����� �ҷ��� �� `getMyPosts({ visibility: "all", size: 100 })`���� ��û�ߴ�.
������ �鿣�� `/me/posts` ����ʹ� `size`�� �ִ� 50���� �����Ѵ�.

```python
size: int = Query(default=50, ge=1, le=50)
```

�׷��� API�� 422 Validation Error�� ��ȯ�߰�, ����Ʈ�� ���� ��� �Խñ� ����� ä���� ���ߴ�.

�ذ�:

- `REVIEW_TARGET_POST_PAGE_SIZE = 50` ����� �������.
- `getMyPosts({ visibility: "all", size: REVIEW_TARGET_POST_PAGE_SIZE })`�� �����ߴ�.
- ���������� �ٽ� Ȯ������ �� QA �Խñ��� ���� ��� ��ϰ� �̸����⿡ ǥ�õƴ�.

��� ��:

- ȭ�鿡 ���� validation ������ ���̸� �鿣�� API ���� ������ ���ɼ��� ����.
- ����Ʈ API ȣ�Ⱚ�� �鿣�� Query ���Ѱ� ����� �Ѵ�.
- ���� API�� `Promise.all`�� ������ �ϳ��� API ���а� ��ü ȭ�� ������ �ε� ����ó�� ���� �� �ִ�.
- �̷� ���ڴ� �׳� �ھƵα⺸�� �ǹ� �ִ� ����� ���θ� ������ ã�� ����.
---

## 2026-06-15 Ʈ��������: DB/API�� �ֽ��ε� ������ role/status�� ���� ����

����:

- DB���� ���� ��û�� `�ǵ�� �Ϸ�`�� �ٲ����.
- ���� `localhost:8000 /review-requests/inbox`�� `�ǵ�� �Ϸ�`�� ��ȯ�ߴ�.
- ������ ������ ��ġ �ιڽ��� ��� `��� ��`���� ������.
- QA �� DB���� ���� ����ڸ� `ADMIN`���� ���������� ������ ���̵�ٴ� �ѵ��� `COACH` �޴��� �������.

����:

- ���� �� �ִ� Vite dev server�� HMR state�� ������ ĳ�ð� ���� �ֽ� `/auth/me`, `/review-requests/inbox` ������ ȭ�鿡 ���������� �ݿ����� �ʾҴ�.
- access token�� ª�� ����Ǵ� �����ε� �Ϲ� ���� API���� 401 �߻� �� refresh retry�� �������� ó������ �ʾҴ�.

�ذ�:

- `frontend/src/app/api/client.ts`�� `apiFetch()`�� �߰��ߴ�.
- 401 ���� �� `/auth/refresh`�� �� �� ȣ���� �� ���� ��û�� ��õ��ϵ��� �ߴ�.
- ���� API Ŭ���̾�Ʈ�� ���� `apiFetch()`�� ����ϵ��� �ٲ��.
- ����/��ȸ API�� `cache: "no-store"`�� �߰��ߴ�.
- ���� �� �ִ� 5173 Vite dev server�� ������ߴ�.

������ ����� ������ ���� Ȯ���� ����:

1. DB ���� ���� Ȯ���Ѵ�.
2. ���� ���� ���� `localhost:8000` API ������ Ȯ���Ѵ�.
3. ������ ȭ�� state�� Ȯ���Ѵ�.
4. API ������ �´µ� ȭ�鸸 �ٸ��� cache/HMR/dev server�� �ǽ��Ѵ�.
5. `npm run build`�� �ҽ� �������� dev server ���� �������� �и��Ѵ�.

---

## 2026-06-16 PowerShell ������ �ѱ� ���ͷ� ���ڵ� QA �̽�

��Ȳ:

- ��Ʈ������ ���Ž� placeholder ���͸� �����Ϸ��� PowerShell here-string �ȿ� �ѱ� ������ ���� ���� Python���� pipe�ߴ�.
- Python �ڵ� ������ ������ DB�� �� �ѱ� ���ڿ��� ���� exact match�� �����ߴ�.

����:

- PowerShell pipe�� Python ǥ�� �Է� ���̿��� �ѱ� ���ڵ��� ����� �ٸ��� ó���ƴ�.
- ��� ���� ������ �ƴ϶� QA ��ũ��Ʈ �Է� ���ڿ��� ���� �ڵ� ����� �޶��� ��������.

�ذ�:

- �ѱ� ������ QA ��ũ��Ʈ�� ���� ���� �ʰ� `portfolio_service.py`�� `LEGACY_*_PLACEHOLDERS` ����� import�ؼ� ����ߴ�.
- ��� ���� ����� ��� ���Ž� placeholder ���Ͱ� ���� �����ߴ�.

��� ��:

- �ѱ� exact match�� ������ ���� �͹̳� �Է� ���ڵ����� �ڵ� ���� ����� ���� ��� �Է��� ���� ���� �����ϴ�.

---

## 2026-06-16 PowerShell ������ �ѱ� ���°� Pydantic ���� �̽�

��Ȳ:

- ��ġ ���� QA ��ũ��Ʈ���� `�ǵ�� �Ϸ�` ���� ���ڿ��� PowerShell here-string���� Python�� �����ߴ�.
- Python �ʿ��� ���ڿ��� `??? ??`ó�� ���� Pydantic Literal ������ �����ߴ�.

����:

- PowerShell ǥ�� �Է� ������ �������� �ѱ� ���ͷ� ���ڵ��� ������.
- �鿣�� status validation ���� ������ �ƴϾ���.
