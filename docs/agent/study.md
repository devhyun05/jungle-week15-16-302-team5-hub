...
## 2026-06-16 학습 기록: 선택 카드 hover/active UI

이번 수정은 기능 로직이 아니라 JSX className 조건부 렌더링을 이용한 UI 상태 표현입니다.

관련 파일:

| 파일 | 역할 |
| --- | --- |
| `frontend/src/app/pages/portfolio/Portfolio.tsx` | 포트폴리오 게시글 발행 모달의 공개/비공개 선택 UI를 렌더링합니다. |
