...
## 2026-06-16 추가: 포트폴리오 AI 결과 저장 필드

포트폴리오 프로젝트 API가 면접 예상 질문 저장 결과를 함께 다루도록 확장됐다.
...
| 필드 | 타입 | 설명 |
| --- | --- | --- |
| `savedInterviewQuestions` | `string | null` | AI 도우미에서 만든 면접 예상 질문 결과를 프로젝트에 저장한다. |
...
| 필드 | 타입 | 설명 |
| --- | --- | --- |
| `savedInterviewQuestions` | `string | null` | 프로젝트에 저장된 면접 예상 질문 본문이다. |
| `aiInterviewSaved` | `boolean` | 저장된 면접 예상 질문이 있으면 `true`로 계산된다. |

프론트 연결:

- `frontend/src/app/api/portfolio.ts`의 `PortfolioProjectApiItem` 타입에 위 필드가 추가됐다.
- AI 도우미는 `savedInterviewQuestions`를 PATCH하고, 포트폴리오 화면은 `aiInterviewSaved`로 badge 상태를 표시한다.
...
| �ʵ� | Ÿ�� | ���� |
| --- | --- | --- |
| `savedInterviewQuestions` | `string | null` | AI ����̿��� ���� ���� ���� ���� ����� ������Ʈ�� �����Ѵ�. |
...
| �ʵ� | Ÿ�� | ���� |
| --- | --- | --- |
| `savedInterviewQuestions` | `string | null` | ������Ʈ�� ����� ���� ���� ���� �����̴�. |
| `aiInterviewSaved` | `boolean` | ����� ���� ���� ������ ������ `true`�� ���ȴ�. |
